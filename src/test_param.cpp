...
//  initscr();
  ...
  if (vm.count("output-file")) {
    ...
    char temp[1000];
    snprintf(temp, 1000, "/home/birromer/mega/datasets/tiles_loc/%s/test_sim.csv", DATASET);
  ...
  char path_gt[1000];
  snprintf(path_gt, 1000, "/home/birromer/mega/datasets/tiles_loc/%s/gt.csv", DATASET);
  ...
  snprintf(path_error, 1000, "/home/birromer/mega/datasets/tiles_loc/%s/error.csv", DATASET);
...
//    expected_3 = modulo(pose_3+M_PI/4., M_PI/2.)-M_PI/4.;
    ...
    char path_img[1000];
    snprintf(path_img, 1000, "/home/birromer/mega/datasets/tiles_loc/%s/dataset_tiles/%06d.png", DATASET, curr_img);
